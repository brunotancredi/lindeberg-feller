...
The reference material has been drawn from [@gut2013probability], [@Vaart_1998], and lecture notes by Prof. Marco Scavino for the Probability II course at the Universidad de la República.
...
viewof distribucion = Inputs.radio(["Uniform", "Exponential"], {value: "uniforme", label: "Distribution"})
...
A cool application of Lindeberg-Feller theorem is in the area of Linear Regression. 

For simplicity we are going to prove it for Simple Linear Regression, but it can be prove. L
