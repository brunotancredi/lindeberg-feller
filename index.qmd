...
I’m going to present generalizations of the Central Limit Theorem, such as the Lindeberg–Levy–Feller Central Limit Theorem and Lyapunov’s Central Limit Theorem. 
...
But is easy to see that is equivalent at the one stated above
...
In @fig-lindeberg_convergence, we can see how $L_1$ is not satisficied, since instead of converging to 0 it bounces, even with $n=500,000$.
